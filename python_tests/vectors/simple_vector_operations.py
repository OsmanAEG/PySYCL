...
def basic_addition(N):
  ...
  c = vector.vector_addition(a, b, q)
...
def basic_subtraction(N):
  ...
  c = vector.vector_subtraction(a, b, q)
  check_vector_full_value(c, expected_result)
...
def basic_element_multiplication(N):
  ...
  c = vector.vector_element_multiplication(a, b, q)
  check_vector_full_value(c, expected_result)
...
def basic_element_division(N):
  ...
  c = vector.vector_element_division(a, b, q)
  check_vector_full_value(c, expected_result)
...
def vector_sum_reduction(N):
  ...
  a_sum = vector.vector_sum_reduction(a, q)
...
def vector_min_reduction(N):
  ...
  a_min = vector.vector_min_reduction(a, q)
...
def vector_max_reduction(N):
  ...
  a_max = vector.vector_max_reduction(a, q)
...
def vector_dot_product(N):
  ...
  a_dot_b = vector.vector_dot_product(a, b, q)
