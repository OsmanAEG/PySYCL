...
auto Device_Instance::vendor() {
  const std::string vendor = Q.get_device().get_info<sycl::info::device::vendor>();
  return vendor;
}
...
/////////////////////////////////////////////////////////////////////////
auto Device_Instance::get_platform_index() const {
  return platform_idx;
}

/////////////////////////////////////////////////////////////////////////
auto Device_Instance::get_device_index() const {
  return device_idx;
}
